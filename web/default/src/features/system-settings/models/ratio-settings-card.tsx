...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    ModelCost: createJsonStringField(t),
    ModelPricingSource: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    ModelCost: normalizeJsonString(modelDefaults.ModelCost),
    ModelPricingSource: normalizeJsonString(modelDefaults.ModelPricingSource),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        ModelCost: normalizeJsonString(values.ModelCost),
        ModelPricingSource: normalizeJsonString(values.ModelPricingSource),
